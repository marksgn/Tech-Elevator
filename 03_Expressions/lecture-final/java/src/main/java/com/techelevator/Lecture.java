...
public class Lecture {
    ...
    */
    public String returnName() {
    	int x  = 4; 
    	//return 1; compile error, must return correct data type
        return "any string";
        //int y = 8; unreachable code
    }
    ...
    */
    public boolean returnTrueWhenOneEqualsOne() {
       ...
       // else if (1!=1) { this breaks if that not all code paths return a value 
        	return false; 
      //  }

       // return false;
        
        //this is logically equivalent to having else { return false;}
        
        //you do have to return somewhere
    ...
    */
    public boolean returnTrueWhenGreaterThanFive(int number) {
        ...
        //return (number>5); elegant code that you dont need to worry about
    }
    ...
    */
    public String returnFizzIfThreeUsingTernary(int number) {
    	/* (expression_that_evaluates_to_true_or_false) ? exp_if_true : exp_if_false;
    	if (expression_that_evaluates_to_true_or_false)
    	  exp_if_true
    	else
          exp_if_false
    	*/
    	...
    	if (5<10)
    	 ...
    	 //Write a ternary statement that returns "Fizz" if the parameter is 3 and returns an empty String for anything else
