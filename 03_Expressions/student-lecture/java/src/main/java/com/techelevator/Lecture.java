...
public class Lecture {
    ...
    */
    public boolean returnTrueWhenOneEqualsOne() {
    	...
    	//your do have to return somewhere
    ...
    */
    public String returnFizzIfThreeUsingTernary(int number) {
       ...
       */
    	...
    	//Write an if/else statement that returns "Fizz" if the parameter is 3, "Buzz" if the parameter is 5 and an empty String for anything else.
