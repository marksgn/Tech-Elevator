...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		int differenceBtwn121And127 = 121-27;
		...
		*/
		...
		movieTitle = movieTitle + sequelNumber; //al
