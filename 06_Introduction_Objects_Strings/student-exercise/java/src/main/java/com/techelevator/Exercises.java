...
public class Exercises {
	...
	public String middleTwo(String str) {
		//string - length 6, mid index = 3
		
		//shortest - "ab, length is 2, (2/2 = 1 - 1 = 0), startIndex = 0
	...
	public String twoChar(String str, int index) {
		//index too big index >= str.length -2; index too small < 0
		//***SAME return (index > str.length() - 2 || index < 0) ? str.substring(0,2) : str.substring(index, index+2); ***SAME
	...
	public String middleThree(String str) {
		//Candy - length - 5, midIndex is 2, we want 1, 2, 3 (can)
		//solving - length is 7, midIndex is 3, we want 2, 3, 4 (lvi)
		//abcdefghijk - length is 11, midIndex is 5, we want 4, 5, 6 (efg)
	...
	public String stringX(String str) {
		...
		return str.charAt(0) + subStr + str.charAt(length -1);
	}
	...
	public String stringYak(String str) {
		//1. really get to know regular expressions and search for 'y' '<any single char' 'k'
		//treat the string as an array of chars, search for y and when i find it, check it i+2 is k
