...
public class Lecture {
    ...
    */
    public boolean returnOperationInBlock() {
        ...
        //can't use multiplier here becuase it's out of scope
    ...
    */
    public boolean returnCounterFromLoop() {
        ...
        // i =0, counter=0 , arrayToLoopThrough.length is 4
        // counter=1
        // i=1
        // counter =2
        // i=2
        ...
        //declaredInForLoop++; out of scope. only accessible inthe loop due to scope
