...
SELECT payment.*, customer, first_name, customer.last_name, rental.return_date, inventory.fil_id
FROM payment 
INNER JOIN customer ON customer.customer_id = payment.rental_id
