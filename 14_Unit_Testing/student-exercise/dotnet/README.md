...
* Create a test class for the class you'll test. For instance, if you're testing the `WordCount` class, create a class in the `Exercises.Tests` project called `WordCountTests`.
